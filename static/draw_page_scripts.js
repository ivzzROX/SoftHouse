...
//	});
    ...
    objectList.forEach(function (obj) {
        console.log("obj: " + obj.id + " type: " + obj.type + " logic: " + obj.logicType + " ctx" + obj.ctx);
    });

    linkList.forEach(function (line) {
        console.log("link: " + line.id + " from obj: " + line.blockFrom.id + " to obj: " + line.blockTo.id + " ctx" + line.ctx);
    });
}
